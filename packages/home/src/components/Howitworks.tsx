...
export default function HowItWorks() {
  return (
    <section id="how-it-works" className="px-6 py-20 bg-(--color-base-200) border-y-2 border-outline">
      <div className="max-w-4xl mx-auto text-center">
        <h2 className="font-display text-3xl sm:text-4xl text-(--color-neutral) mb-3">
          How it works
        </h2>
        <p className="max-w-xl mx-auto mb-12">
          One command turns a codebase into text. One command turns it back.
        </p>

        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {steps.map((step, i) => (
            <div key={step.title} className="pendex-card p-5 flex flex-col items-center gap-3 relative">
              <span
