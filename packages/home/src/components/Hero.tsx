    ...
    <section id="top" className="px-6 pt-16 pb-20 text-center">
      <div className="max-w-3xl mx-auto flex flex-col items-center gap-6">
        ...
        <p className="max-w-xl text-base sm:text-lg leading-relaxed">
          Turn an entire source tree into portable, plain-text archives —
          ideal for AI prompts, code reviews, backups, and sharing. Compile a
          project into banner-delimited <code>.txt</code> files grouped by
          job, then reconstruct the whole tree later with{' '}
          <code className="pendex-card px-1.5 py-0.5">px split</code>.
        </p>

        <CodeBlock label="pendex" lines={['bun install -g pendex', 'px compile']} />
