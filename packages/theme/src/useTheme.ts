 ...
 *
 * @param activeTheme - The flat, already-resolved theme whose styler functions back this chain.
 * @param initialTxt - Text already accumulated in the chain (internal recursion state).
