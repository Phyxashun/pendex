...
//
/**
 * @file packages/split/tests/preload.ts
 * @description Package-isolated preload for @pendex/split. Mocks UI interactions
 * and handles cleanup for test sandboxes scoped strictly to packages/split/tests/.
 */
/**
 * @file packages/compile/tests/preload.ts
 * @description Package-isolated preload for @pendex/compile. Mocks UI interactions
 * and handles cleanup for test sandboxes scoped strictly to packages/compile/tests/.
 */
